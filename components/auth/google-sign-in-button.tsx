...
export function GoogleSignInButton() {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="flex items-center gap-2 rounded-full bg-foreground px-4 py-1.5 text-xs font-bold text-background transition-colors hover:bg-foreground/90 disabled:opacity-50"
    >
